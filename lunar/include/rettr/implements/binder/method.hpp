...
namespace rettr::implements {
    ...
    public:
        ...
        template<std::size_t... Is>
        static auto make_wrapper_tuple_type(std::index_sequence<Is...>)
            -> wrapper_tuple_impl<Is...>;
    ...
    private:
        ...
        void apply_names_(const std::array<string_view, N> &names,
        ...
        void apply_(default_arguments_tag<Defaults...> &&tag) {
            ...
            defaults_applier_ = [this, vals = std::move(tag.values)](function &fn) mutable {
                ...
                apply_defaults_(impl, vals,
                                std::make_index_sequence<sizeof...(Defaults)>{},
        ...
        void commit_impl_(std::index_sequence<Is...>) {
            std::array<parameter_info_base *, arity> ptrs{
